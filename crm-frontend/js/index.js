...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  /**
   * Предотвращение отправки формы при нажатии на Enter
  ...
  /**
   * Добавляем обработчик события ввода для поиска клиентов по введенным данным.
  ...
  //   table.handlerFindClient(event);
  // });

  // inputSearch.addEventListener("focus", (event) => {
  //   table.handlerFocusCliient(event);
  // });


  /**
   * Добавляем обработчик события клика для добавления нового клиента.
